...
#
# Data flow:
#   right-top  -> rt/target_state   (AprilTag; camera NOT doing ball detection)
#   right-mid  -> rt/lidar_ball_state
#   right-bot  -> rt/ball_state     (fused output; camera ball input absent)
#   left-bot   subscribes rt/target_state + rt/lidar_ball_state + rt/ball_state
#              -> browser http://<robot>:8091/
