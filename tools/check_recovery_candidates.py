...
def main():
    ...
    results={}
    for profile in ['ft_r0_9500','ft_r1_9999','ft_r2_9000','d4_9999']:
    ...
    (ROOT/'outputs/recovery_candidates/interface_validation.json').write_text(json.dumps(results,indent=2)+'\n')
