    ...
    with mujoco.viewer.launch_passive(m, d) as viewer:
        ...
        while viewer.is_running() and Running:
            try:
                ...
                l2_pressed = joystick.get_axis_value(2) > 0.5
                l2_just_released = prev_l2_pressed and not l2_pressed
                ...
                elif joystick.is_button_released(JoystickButton.Y) and not joystick.is_button_pressed(JoystickButton.L1):  # AMP Recovery (get-up), Y
                    state_cmd.skill_cmd = FSMCommand.CMD_AMP_RECOVERY

                prev_hat = hat
                prev_r2_pressed = r2_pressed
                prev_l2_pressed = l2_pressed
